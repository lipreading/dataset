const { readDir, rmDir, mkDir, removeFile } = require('../js-modules/utils/util');
const { spawn } = require('child_process');

const devide = async () => {
    const dirs = readDir('videos');
    // const dirs = ['0Di38ACxCFI'];

    //ffmpeg -i res/videos/0Di38ACxCFI/0Di38ACxCFI.mp4 res/videos/0Di38ACxCFI/frames/thumb%04d.jpg -hide_banner
